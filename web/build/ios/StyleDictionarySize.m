...
float const SizeOutlinePrimaryWidth = 0.16f;
float const SizeOutlinePrimaryOffset = 0.16f;
float const SizePaddingXsmall = 3.20f;
float const SizePaddingSmall = 8.00f;
float const SizePaddingMedium = 16.00f;
float const SizePaddingLarge = 32.00f;
